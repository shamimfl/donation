        ...
        <div className='my-10 p-5 md:flex justify-between items-center'>
            <div className='p-5  md:w-96 w-80 shadow  rounded mx-auto '>
                <div className='flex gap-5 items-center justify-center my-5'>
                    ...
                    <Link to='/registration' className='btn-primary border-2 border-primary bg-white rounded-sm py-1 px-3 font-bold'>Sign up</Link>
                </div>
                <form>
                    ...
                    <input type="Password" placeholder='Password ******' className='input input-bordered my-3 w-full' />
                    
                    <input type="submit" className='btn btn-secondary  mt-5 rounded-sm w-full' value='Login' />
                </form>
                <Social></Social>
            </div>
